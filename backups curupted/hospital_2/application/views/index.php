...
<html>
    ...
    <body>
        <br>
        <img src="assets/img/national.png" class="img-responsive center-block" alt="donate thumbanail" style="width:90px;height:120px;" >
        <div class="center-block"><h3><center><font color="brown"> Government Service Rating Application <br> Hospital Section</font></center></h3></div>
                ...
                <div class="panel-body">
                    ...
                    <form action="index.php/users/login" method="post" id="loginForm">
                        ...
                        <div class="form-group">
                          ...
                          <input type="password" class="form-control clearable" id="password" name="password" placeholder="Password" autofocus>
                        </div>
