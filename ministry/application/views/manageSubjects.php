                                ...
                                <div class="content">
                                    <div class="row">
                                        <div class="col-sm-12 form-group sameline">
                                            <form action="Articles/addNewSubject" method="post" id="newSubject" name="newSubject" >

                                            <!--                                            <div class="form-group">-->
<!--                                                <label>Subject Name</label>-->
                                                <input type="text" class="form-control border-input clearable"  name="subCode" id="subCode" placeholder="Subject Code">
<!--                                            </div>-->
<!--                                            <div class="form-group">-->
<!--                                                <label>Subject Name</label>-->
                                                <input type="text" class="form-control border-input clearable"  name="subName" id="subName" placeholder="Subject Name">
<!--                                            </div>-->
...
<!--<script src="../assets/jquery/demo.js"></script>-->
    <script src="../custom/js/manageSubjects.js"></script>
