            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Pending Clinics</h4>
                                <p class="category">Publish/Edit Pending Clinics</p>
                            </div>
                            <div class="content table-responsive table-full-width">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php $i = 1;
                                        foreach($draftClinics as $clinic) {  ?>
                                            <tr>
                                                <td><?php echo "0".$i ?></td>
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                ...
                                <form action="Articles/updateClinic" method="post" name="updateClinicForm" id="updateClinicForm" onsubmit="return confirm('Are you sure to submit this clinic?');">
                                    <input type="hidden" id="pageToRedirect" name="pageToRedirect" value="1" >
                                    <div class="row">
                                        <div class="col-sm-8">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control border-input clearable" name="contact" id="contact" required>
